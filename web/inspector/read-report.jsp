...
<head>
    ...
    <title><fmt:message key="inspector.work"/></title>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div id="form" style="position: relative; width: 83%; left: 17%; ">
        <div class="col-md-8 order-md-1">
            ...
            <form class="rounded" style="padding: 10px; border:1px solid #999ea0">
                ...
                <div class="mb-3">
                    ...
                    <input value="${report.innCode}" disabled style="width: 48%;" type="text" class="form-control"
                ...
                <div class="row" style="position: relative">
                    <div class="col-md-6 mb-3">
                        ...
                        <input value="${report.periodStart}" disabled style="width: 100%;" name="date" required
                               id="date1" type="date" class="form-control">

                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="date2"><fmt:message key="report.periodEnd"/></label>
                        <input value="${report.periodEnd}" disabled style="width: 100%;" name="date" required id="date2"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-label-group">
                            <input value="${report.incomeCode}" disabled style="width: 100%;" type="text"
                                   name="incomeCode" id="incomeCode" class="form-control"
                                   placeholder="<fmt:message key="report.incomeCode"/>" required autofocus>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <input value="${report.incomeValue}" disabled style="width: 100%;" type="text"
                               name="incomeValue"
                               id="incomeValue" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input value="${report.outcomeCode}" disabled style="width: 100%;" type="text"
                               name="outcomeCode"
                               id="outcomeCode" class="form-control"
                               placeholder="<fmt:message key="report.incomeCode"/>" required autofocus>
                    </div>
                    <div class="col-md-6 mb-3">
                        <input value="${report.outcomeValue}" disabled style="width: 100%;" type="text"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input value="${report.percentCode}" disabled style="width: 100%;" type="text"
                               name="procentCode"
                               id="procentCode" class="form-control"
                               placeholder="<fmt:message key="report.incomeCode"/>" required autofocus>
                    </div>
                    <div class="col-md-6 mb-3">
                        <input value="${report.percentValue}" disabled style="width: 100%;" type="text"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input value="${report.clearCode}" disabled style="width: 100%;" type="text" name="clearCode"
                               id="clearCode" class="form-control" placeholder="<fmt:message key="report.incomeCode"/>"
                               required autofocus>
                    </div>
                    <div class="col-md-6 mb-3">
                        <input value="${report.clearValue}" disabled style="width: 100%;" type="text" name="clearValue"
        ...
        <form style="position: relative; width: 500px; left: 15%" method="post"
              action="${pageContext.request.contextPath}/inspector?command=report&reportId=${reportId}">
            <h5 style="position: relative; width: 500px; left: 40%"><fmt:message key="report.chose"/></h5>
            <input hidden name="reportId" value="${reportId}">
            ...
            <div class="form-group">
                ...
                <textarea name="message" required placeholder="<fmt:message key="report.add"/>" class="form-control"
