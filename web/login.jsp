...
<head>
    ...
    <title><fmt:message key="log.form"/></title>
...
<div class="container">
    <form class="form-signin" name="login" method="post" action="${pageContext.request.contextPath}/login">
        ...
        <p></p>
        <p><fmt:message key="log.haveno"/><a href="${pageContext.request.contextPath}/register"
                                             class="btn-link"><fmt:message key="log.reg"/></a></p>
