        ...
        <div id="form" style="position: relative; width: 83%; left: 12%; ">
            <div class="col-md-8 order-md-1">
                <form class="needs-validation" method="post"
                      action="${pageContext.request.contextPath}/user?command=update-profile">
                    <div class="mb-3">
                        <label for="surname"><fmt:message key="uprofile.surname"/><span
                    ...
                    <div class="mb-3">
                        <label for="patronymic"><fmt:message key="uprofile.patron"/><span
                                class="text-muted"></span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="number" name="number" class="form-control" required pattern="[\d]{8,10}"
                               title="<fmt:message key="reg.codeHelp"/>" placeholder="<fmt:message key="reg.code"/>"
                               type="text" value="${user.identificationCode}">
                    </div>
                    <div class="mb-3">
                        <label for="password"><fmt:message key="uprofile.updatePass1"/><span class="text-muted"></span></label>
