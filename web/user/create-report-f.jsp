                ...
                <div class="col-xs-12 ">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link " id="nav-home-tab"  href="${pageContext.request.contextPath}/user?command=add_report"  aria-selected="false"><fmt:message key="report.form"/></a>
                            <a class="nav-item nav-link active" id="nav-profile-tab" href="${pageContext.request.contextPath}/user?command=add_report_file" aria-selected="true"><fmt:message key="report.file"/></a>
                        </div>
                    </nav>
...
<p></p>
    ...
    <div id="form" style="position: relative; width: 83%; left: 17%; ">
        ...
        <div  class="col-md-8 order-md-1" >
            <form class="needs-validation" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/user?command=add_report_file">
