    ...
    <div id="form" style="position: relative; width: 83%; left: 17%; ">
        ...
        <div class="col-md-8 order-md-1">
            <form class="needs-validation" enctype="multipart/form-data" method="post"
                  action="${pageContext.request.contextPath}/user?command=add-report-file">
                <div class="file-field">
                    <div class="btn btn-primary btn-sm" style="position: relative; left: 36%;">
                        <input required type="file" placeholder="<fmt:message key="report.filetype"/>"
                               accept=".json,.xml" name="file" id="customFileLang" lang="">
