...
<head>
    ...
    <title><fmt:message key="string"/></title>
            ...
            <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                <div class="about-text">
                    ...
                    <div class="custom-btn-group mt-4">
                        <a href="${pageContext.request.contextPath}/login" class="btn mr-lg-2 custom-btn"><i
                                class='uil uil-file-alt'></i><fmt:message key="index.log"/></a>
                        <a href="${pageContext.request.contextPath}/register"
                           class="btn custom-btn custom-btn-bg custom-btn-link"><fmt:message key="index.reg"/></a>
                    </div>
                </div>
            </div>
