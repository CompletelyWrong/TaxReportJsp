...
<head>
    ...
    <title><fmt:message key="admin.inspectorList"/></title>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <h2 style="position: relative; width: 500px; left: 40%"><fmt:message key="admin.inspectorList"/></h2>
            ...
            <ul class="pagination">
                <c:if test="${currentPage != 1}">
                    <li class="page-item"><a class="page-link"
                                             href="${pageContext.request.contextPath}/admin?command=inspectors&currentPage=${currentPage-1}"><</a>
                    </li>
                </c:if>
                ...
                <c:forEach begin="1" end="${numberOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/admin?command=inspectors&currentPage=${i}">${i}</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
